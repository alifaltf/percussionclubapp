...
export default function AnnouncementsFilterBar() {
  ...
  return (
    <div className="rounded-2xl border border-[#E8E8E8] bg-white p-5">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          <label htmlFor="announcement-search" className={LABEL_CLASSES}>
            Search
          </label>
          <input
        ...
        <div>
          <label htmlFor="announcement-filter" className={LABEL_CLASSES}>
            Filter
          </label>
          <select
