...
import { EVENT_STATUSES, EVENT_STATUS_LABELS } from "@/types/event";
...
export default function EventsToolbar() {
  ...
  const sort = searchParams.get("sort") ?? "event-date-asc";
    ...
    <div className="rounded-2xl border border-[#E8E8E8] bg-white p-5">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        <div className="sm:col-span-2 xl:col-span-1">
          <label htmlFor="admin-event-search" className={LABEL_CLASSES}>
            Search
          </label>
          <input
        ...
        <div>
          <label htmlFor="admin-event-status" className={LABEL_CLASSES}>
            Status
          </label>
          <select
        ...
        <div>
          <label htmlFor="admin-event-archive" className={LABEL_CLASSES}>
            Archive
          </label>
          <select
            id="admin-event-archive"
            value={archive}
        ...
        <div>
          <label htmlFor="admin-event-featured" className={LABEL_CLASSES}>
            Featured
          </label>
          <select
        ...
        <div>
          <label htmlFor="admin-event-sort" className={LABEL_CLASSES}>
            Sort
          </label>
          <select
            id="admin-event-sort"
            ...
            className={SELECT_CLASSES}
          >
            <option value="event-date-asc">Event Date (Soonest)</option>
            <option value="event-date-desc">Event Date (Latest)</option>
