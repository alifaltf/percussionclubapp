...
export default function EventsSkeletonGrid() {
  return (
    <div aria-hidden="true">
      ...
      <div className="mt-4 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
        {SKELETON_CARDS.map((_, index) => (
          <div
            key={index}
            className="overflow-hidden border border-[#E8E8E8] bg-white"
          >
            <div className="aspect-[16/10] w-full animate-pulse bg-[#F8F8F6]" />
