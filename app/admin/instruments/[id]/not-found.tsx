...
export default function AdminInstrumentNotFound() {
  return (
    <main className="flex flex-1 flex-col items-center justify-center bg-[#F8F8F6] px-6 py-24 text-center">
      ...
      <p className="mt-2 max-w-sm text-sm text-[#666666]">
        This instrument doesn&apos;t exist or may have been removed.
      </p>
      <Button href="/admin/instruments" variant="outline" className="mt-6">
        Back to Instruments
      </Button>
    </main>
  );
